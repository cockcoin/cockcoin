Cockcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cockcoin/files/Cockcoin/cockcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cockcoin
...
New/changed settings (command-line or cockcoin.conf file)
--------------------------------------------------------
