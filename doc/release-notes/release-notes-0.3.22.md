Download URL: https://sourceforge.net/projects/cockcoin/files/Cockcoin/cockcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CKC fee schedule (users still pay 0.01 CKC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #cockcoin00 - #cockcoin99
