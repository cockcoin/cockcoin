Cockcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cockcoin/files/Cockcoin/cockcoin-0.5.4/
...
http://gitorious.org/cockcoin/cockcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cockcoin-Qt notifications under Growl 1.3.
Increase required age of Cockcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCockcoin properly when installing Cockcoin-Qt over it. (Windows)
