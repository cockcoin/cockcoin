The following is a list of assets used in the cockcoin source and their proper attribution.
...
* License: MIT
* Site: [https://cockcointalk.org/index.php?topic=15276.0](https://cockcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original cockcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/cockcoin.icns, src/qt/res/src/cockcoin.svg,
	src/qt/res/src/cockcoin.ico, src/qt/res/src/cockcoin.png,
	src/qt/res/src/cockcoin_testnet.png, docs/cockcoin_logo_doxygen.png,
