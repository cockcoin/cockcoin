...
unlocked to sign the Cockcoin-Qt.app bundle.
...
allowing somebody to distribute a Cockcoin-Qt.app or cockcoin-qt-setup.exe with a valid
...
that the cockcoin-qt.exe file inside the installer had not been tampered with.
