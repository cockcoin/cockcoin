...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old CockcoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/CockcoindComparisonTool_jar/CockcoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/cockcoin/cockcoin.git")
...
environ_default("BUILD_PATH", "/mnt/cockcoin")
...
environ_default("GITHUB_REPO", "cockcoin/cockcoin")
