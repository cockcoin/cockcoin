...
#ifndef H_COCKCOIN_SCRIPT
#define H_COCKCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCockcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Cockcoin always counted CHECKMULTISIGs
