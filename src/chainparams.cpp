...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("cockcoin.sipa.be", "seed.cockcoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.cockcoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("cockcoinstats.com", "seed.cockcoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("cockcoin.petertodd.org", "testnet-seed.cockcoin.petertodd.org"));
